...
describe FullTextController, type: :controller do
  ...
  [SearchStrategies::Pg].each do |strategy|
    ...
    context strategy.name.demodulize.downcase do
      ...
      describe 'GET index' do
        ...
        context 'json' do
          ...
          it 'finds groups' do
            get :index, params: { q: groups(:bottom_layer_one).to_s[1..5] }, format: :json
      ...
      describe 'GET query' do
        ...
        # ipa out of scope
        xit 'only finds invoices with permissions' do
