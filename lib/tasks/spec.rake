...
# Rake.add_rakelib 'rspec/rails/tasks'


Rake::Task['spec:features'].actions.clear if Rake::Task.task_defined?('spec:features') # only if current environment knows rspec
namespace :spec do
