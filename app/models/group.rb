...
class Group < ActiveRecord::Base # rubocop:disable Metrics/ClassLength
  ...
  SEARCH_ATTRS = {
    name: 'A', short_name: 'B', email: 'B', address: 'B', zip_code: 'B', town: 'B', country: 'B'
  }
  ASSOCIATED_SEARCH_ATTRS = {
    parent: {name: 'B', short_name: 'B'}, phone_numbers: {number: 'B'}, 
    social_accounts: {name: 'B'}, additional_emails: {email: 'B'}
  }
